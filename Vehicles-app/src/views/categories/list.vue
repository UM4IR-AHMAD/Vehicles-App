  ...
  <div class="w-full px-6 py-6 mx-auto">
    ...
    <div v-show="categories.last_page > 1">
      <div class="flex justify-end">
        <button v-if="categories.current_page > 1" @click="getByPageNo()"
        ...
        <!-- page links creation -->
        <template v-for="(link, index) of categories.links" :key="index">
          <button v-if="link.label >= 1 && link.label <= categories.last_page" @click="getByPageNo(link.label)"
        ...
        <button v-if="categories.current_page < categories.last_page" @click="getByPageNo(categories.last_page)"
